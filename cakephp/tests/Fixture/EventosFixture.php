...
class EventosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'pessoas_previstas' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'nome' => 'Evento Teste Fixture',
            'data' => '2017-07-28 16:01:24',
            'localizacao' => 'Lorem ipsum dolor sit amet',
            'pessoas_previstas' => 1,
            'created' => '2017-07-28 16:01:24',
            'modified' => '2017-07-28 16:01:24'
        ],
    ];
}
