...
class ConsumablesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'consumables_ibfk_1' => ['type' => 'foreign', 'columns' => ['eventos_id'], 'references' => ['eventos', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            'id' => 1,
            'nome' => 'Consumable Fixture',
            'eventos_id' => 1,
            'created' => '2017-07-28 17:23:35',
            'modified' => '2017-07-28 17:23:35'
        ],
    ];
}
